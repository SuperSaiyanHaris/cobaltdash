  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#fafaf9]">
        <PageHero
          eyebrow="Milestones · updated daily"
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <button
              ...
              className={`flex items-center gap-2 h-10 px-4 rounded-full text-sm font-semibold whitespace-nowrap transition-colors border flex-shrink-0 ${
                activePlatform === null ? 'bg-white border-white text-neutral-950' : 'bg-white/[0.06] border-white/15 text-white hover:border-white/50'
              }`}
            >
              All platforms
            </button>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 sm:py-10">
          {loading ? (
            ...
            <p className="text-center py-20 text-neutral-600 text-sm">No milestones recorded here yet.</p>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-neutral-600 truncate flex items-center gap-1.5">
