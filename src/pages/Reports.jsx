  ...
  useEffect(() => {
    if (!authLoading && !user) {
      window.dispatchEvent(new CustomEvent('openAuthPanel', {
        detail: { message: 'Sign in to build custom reports and export data.' },
      }));
    }
  }, [user, authLoading]);
        ...
        <div className="border-b border-neutral-200/80 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <div>
                <p className="text-[10px] font-medium uppercase tracking-[0.14em] text-neutral-600 mb-3">Reports</p>
