/**
 * Official YouTube icon (the red rounded-rect play mark), fixed colors.
 *
 * YouTube's brand guidelines prohibit recoloring the standard icon
 ...
 * alone" convention used for every other platform. Use this specifically
 * wherever the mark identifies the YouTube platform/brand (nav, footer,
 * search tabs, creator profile badge) — className/style only control size,
 * never color.
 */
export default function YouTubeIcon({ className, style, ...rest }) {
  return (
    <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.5701 20" {...rest}>
      <path
