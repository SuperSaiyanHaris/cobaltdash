...
/* ───────────── main component ─────────────
   Admin-only report builder + CSV export. Formerly the standalone /reports
   page (open to all signed-in users); moved into the admin dashboard so
   bulk data access and export are restricted to admins only. See CLAUDE.md
   "Reports moved to Admin-only" for why. */
